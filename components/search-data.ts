...
const searchData: SearchResult[] = [
  ...
  // Agent page headings
  {
    ...
    url: "/v0/agent#1-launching-the-agent-interface",
    type: "heading",
    parentPage: "Agents",
  },
  {
    title: "Understanding the Agent Menu",
    url: "/v0/agent#2-understanding-the-agent-menu",
    type: "heading",
    parentPage: "Agents",
  },
  {
    title: "Confirming the Agent",
    url: "/v0/agent#3-confirming-the-agent",
    type: "heading",
    parentPage: "Agents",
  },
  {
    title: "Uploading an Input File",
    url: "/v0/agent#4-uploading-an-input-file",
    type: "heading",
    parentPage: "Agents",
  },
  {
    title: "Receiving the Output",
    url: "/v0/agent#5-receiving-the-output",
    type: "heading",
    parentPage: "Agents",
  },
  {
    title: "Inference History",
    url: "/v0/agent#6-inference-history",
    type: "heading",
    parentPage: "Agents",
  },
  {
    title: "Files Created",
    url: "/v0/agent#7-files-created",
    type: "heading",
    parentPage: "Agents",
  },
  {
    title: "Exiting Agents",
    url: "/v0/agent#8-exiting-agents",
    type: "heading",
    parentPage: "Agents",
  },
  ...
  // Multi-Doc Agent page headings
  {
    ...
    url: "/v0/agent/multi-docs-agent#batch-run-overview",
    type: "heading",
    parentPage: "Multi-Doc Agent",
  },
  {
    title: "Uploading Documents for Batch Processing",
    url: "/v0/agent/multi-docs-agent#uploading-documents-for-batch-processing",
    type: "heading",
    parentPage: "Multi-Doc Agent",
  },
  {
    title: "Batch Run Results",
    url: "/v0/agent/multi-docs-agent#batch-run-results",
    type: "heading",
    parentPage: "Multi-Doc Agent",
  },
  ...
  // Creating New Agent headings
  {
    ...
    url: "/v0/agent/create-new-agent#configure-agent",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Inputs",
    url: "/v0/agent/create-new-agent#input",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Agent Setup",
    url: "/v0/agent/create-new-agent#agent-setup",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Agent Builder",
    url: "/v0/agent/create-new-agent#agent-builder",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Building the Process",
    url: "/v0/agent/create-new-agent#building-the-process",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Service Table",
    url: "/v0/agent/create-new-agent#service-table",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Creating an Agent",
    url: "/v0/agent/create-new-agent#how-to-create-an-agent-from-agent-builder",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Creating a Demo_Agent",
    url: "/v0/agent/create-new-agent#creating-a-demo_agent",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Details",
    url: "/v0/agent/create-new-agent#details",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Documentation",
    url: "/v0/agent/create-new-agent#documentation",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Agent Legend",
    url: "/v0/agent/create-new-agent#agent-legend",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  {
    title: "Building a Demo_Agent",
    url: "/v0/agent/create-new-agent#building-a-demo_agent",
    type: "heading",
    parentPage: "Creating New Agent",
  },
  ...
  {
    title: "Building the Process",
    url: "/v0/agent/agent-builder-menu#building-the-process",
    type: "heading",
    parentPage: "Agent Builder Options",
  },
  {
    title: "Inputs",
    url: "/v0/agent/agent-builder-menu#inputs",
    type: "heading",
    parentPage: "Agent Builder Options",
  },
  {
    title: "Files",
    url: "/v0/agent/agent-builder-menu#files",
    type: "heading",
    parentPage: "Agent Builder Options",
  },
  {
    title: "Load",
    url: "/v0/agent/agent-builder-menu#load",
    type: "heading",
    parentPage: "Agent Builder Options",
  },
  {
    title: "Run",
    url: "/v0/agent/agent-builder-menu#run",
    type: "heading",
    parentPage: "Agent Builder Options",
  },
  {
    title: "Reset",
    url: "/v0/agent/agent-builder-menu#reset",
    type: "heading",
    parentPage: "Agent Builder Options",
  },
  ...
  // Editing Agents headings
  {
    ...
    url: "/v0/agent/edit-agent#open-the-edit-interface",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Edit Interface",
    url: "/v0/agent/edit-agent#edit-interface",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "How to Edit an Agent",
    url: "/v0/agent/edit-agent#edit-agent",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Editing a Copy of an Existing Process",
    url: "/v0/agent/edit-agent#copy-process",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Process",
    url: "/v0/agent/edit-agent#process",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Run",
    url: "/v0/agent/edit-agent#run",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Export",
    url: "/v0/agent/edit-agent#export",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Build",
    url: "/v0/agent/edit-agent#build",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Meta",
    url: "/v0/agent/edit-agent#meta",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Options",
    url: "/v0/agent/edit-agent#options",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "JSON Editor",
    url: "/v0/agent/edit-agent#json-editor",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Files",
    url: "/v0/agent/edit-agent#files",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Reports",
    url: "/v0/agent/edit-agent#reports",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Outputs",
    url: "/v0/agent/edit-agent#outputs",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Global",
    url: "/v0/agent/edit-agent#global",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Controls",
    url: "/v0/agent/edit-agent#controls",
    type: "heading",
    parentPage: "Editing Agents",
  },
  {
    title: "Upload",
    url: "/v0/agent/edit-agent#upload",
    type: "heading",
    parentPage: "Editing Agents",
  },
  // OpenAI and Anthropic page headings
  {
    ...
    url: "/v0/agent/openAI-and-anthropic#default-setup",
    type: "heading",
    parentPage: "OpenAi and Anthropic",
  },
  {
    title: "Switching to OpenAI",
    url: "/v0/agent/openAI-and-anthropic#switching-to-openAI",
    type: "heading",
    parentPage: "OpenAi and Anthropic",
  },
