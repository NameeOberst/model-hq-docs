  ...
  return (
    <DocPageLayout references={references}>
      ...
      <div className="prose prose-gray max-w-none">
        ...
        <h2 id="opening-the-configuration-panel">Opening the configuration panel</h2>
        ...
        <h2 id="configuration-parameters-overview">Configuration parameters overview</h2>
        ...
        <h2 id="model-visibility-and-discovery">Model visibility and discovery</h2>
        ...
        <h3 id="show-cached-models-only">Show Cached Models Only</h3>
        ...
        <h3 id="show-model-types">Show Model Types</h3>
        ...
        <h3 id="show-npu-models-first-if-available">Show NPU Models First (if Available)</h3>
        ...
        <ul>
          <li><strong>ON:</strong> Models that support NPU acceleration appear at the top of selection lists, making them easier to discover and select. This is recommended for:
            <ul>
              <li>Devices with dedicated NPU hardware (e.g., Intel Core Ultra processors)</li>
        ...
        <blockquote data-type="note">
            <p>This setting only affects display order when NPU-capable hardware is detected. On systems without NPU support, this setting has no effect.
            </p>
        </blockquote>

        <h2 id="model-naming-and-catalog-size">Model naming and catalog size</h2>

        <p>
          These settings control how models are presented and labeled in the user interface.
        </p>

        <h3 id="model-naming-convention">Model Naming Convention</h3>
        ...
        <h3 id="model-display-sorting">Model Display Sorting</h3>
        ...
        <h2 id="default-model-assignment-by-size">Default model assignment by size</h2>
        ...
        <h3 id="small-model-default">Small Model Default</h3>
        ...
        <h3 id="medium-model-default">Medium Model Default</h3>
        ...
        <h3 id="large-model-default">Large Model Default</h3>
        ...
        <blockquote data-type="note">
            <p>Ensure that sufficient RAM/VRAM is available before configuring large models as defaults, as they may not run on all hardware configurations.
            </p>
        </blockquote>
        ...
        <h3 id="max_output">max_output</h3>
        ...
        <h3 id="sample-in-generation">Sample in Generation</h3>
        ...
        <ul>
          <li><strong>OFF:</strong> The model uses greedy decoding, always selecting the highest-probability token. This produces highly deterministic and repeatable outputs.</li>
        </ul>
        ...
        <blockquote data-type="tip">
            <p>For detailed information about sampling behavior, refer to the <a href="/chat/chatconfiguration">Chat Configuration</a> documentation.
            </p>
        </blockquote>

        <h2 id="task-specific-default-models">Task-specific default models</h2>
        ...
        <ul>
          <li>Users engage in conversational interactions without RAG</li>
        ...
        <h3 id="vision-model">Vision Model</h3>
        ...
        <ul>
          <li>Multimodal capabilities (vision + language)</li>
          <li>Ability to process image inputs</li>
          <li>Strong visual understanding and description capabilities</li>
        </ul>
        ...
        <h3 id="table-reading-model">Table Reading Model</h3>
        ...
        <h3 id="summarizer-model">Summarizer Model</h3>
        ...
        <ul>
          <li>Ability to condense information while retaining key points</li>
          <li>Strong comprehension of source material</li>
          <li>Capability to generate coherent, concise summaries</li>
          <li>Handling of various document lengths and types</li>
        </ul>

        <h3 id="text2sql-model">Text2SQL Model</h3>
        ...
        <ul>
          <li>Natural language database interaction</li>
          <li>CSV-to-database query workflows</li>
          <li>Analytics and reporting automation</li>
          <li>Non-technical user access to structured data</li>
        </ul>
        ...
        <ul>
          <li>Strong understanding of SQL syntax and semantics</li>
          <li>Ability to map natural language to database operations</li>
          <li>Knowledge of common SQL patterns and best practices</li>
        </ul>

        <h3 id="overall-default">Overall Default</h3>
        ...
        <h3 id="dataset-analyzer-model">Dataset Analyzer Model</h3>
        ...
        <h2 id="automation-and-hardware-controls">Automation and hardware controls</h2>

        <p>
          These settings manage how Model HQ automatically selects models and utilizes available hardware resources.
        </p>

        <h3 id="auto-select-models">Auto Select Models</h3>
        ...
        <h3 id="enable-npu-optimized-models">Enable NPU Optimized Models</h3>
        ...
        <h3 id="cpu-only-mode">CPU Only Mode</h3>
        ...
        <h2 id="provider-specific-defaults">Provider-specific defaults</h2>
        ...
        <h3 id="openai-default">OpenAI Default</h3>
        ...
        <h3 id="anthropic-default">Anthropic Default</h3>
        ...
        <h3 id="gemini-default">Gemini Default</h3>
        ...
        <blockquote data-type="note">
            <p>A valid Google API key must be configured in the Integrations section for this provider to function. Usage is subject to Google's pricing and rate limits.
            </p>
        </blockquote>
        ...
        <h3 id="max-model-size">Max Model Size</h3>
        ...
        <h3 id="max-model-local-cache-size">Max Model Local Cache Size</h3>
